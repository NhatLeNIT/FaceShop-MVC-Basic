...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form action="?c=product&a=addProcess" method="post" id="form-input" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 <?php if(isset($name)) echo 'has-error'?>">
                                <input type="text" name="txtName" id="txtName" required="required" class="form-control col-md-7 col-xs-12" value="<?php if(isset($name_old)) echo $name_old?>">
                                <?php if(isset($name)) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 <?php if(isset($code)) echo 'has-error'?>">
                                <input type="text" id="txtCode" name="txtCode" required="required" class="form-control col-md-7 col-xs-12"  value="<?php if(isset($code_old)) echo $code_old?>">
                                <?php if(isset($code)) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 <?php if(isset($price)) echo 'has-error'?>">
                                <input type="number" id="txtPrice" name="txtPrice" required="required" class="form-control col-md-7 col-xs-12"  value="<?php if(isset($price_old)) echo $price_old?>">
                                <?php if(isset($price)) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 <?php if(isset($description)) echo 'has-error'?>">
                                <textarea class="form-control" name="txtDescription" id="txtDescription" rows="8"><?php if(isset($description_old)) echo $description_old?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 <?php if(isset($content)) echo 'has-error'?>">
                                <textarea required class="form-control" name="txtContent" id="txtContent"><?php if(isset($content_old)) echo $content_old?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label><input type="checkbox" name="txtStatus" id="txtStatus" value="1" class="flat" <?php if(isset($status_old) && $status_old == 1) echo 'checked'?> /> <button type="button" class="btn btn-info">Còn hàng</button> </label>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($cateList as $item) { ?>
                                        <optgroup label="<?= $item['name']?>">
                                            ...
                                            foreach ($dataCateChild as $itemChild) {
                                                ?>
                                                <option value="<?= $itemChild['id']?>" <?php if(isset($category_old) && $category_old == $itemChild['id']) echo 'selected'?>><?= $itemChild['name']?></option>
                                            <?php } ?>
                                        </optgroup>
