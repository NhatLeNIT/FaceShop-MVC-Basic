...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form action="?c=category&a=editProcess" method="post" id="form-input" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="txtParent" class="form-control" name="txtParent" required>
                                    ...
                                    <?php foreach ($cateList as $item) { ?>
                                        <option value="<?= $item['id']?>" <?php if(isset($parent_old) && $parent_old == $item['id']) echo 'selected'; else if($item['id'] == $data[0]['id_parent']) echo 'selected' ?> ><?= $item['name']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
